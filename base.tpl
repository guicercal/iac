                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-2"></div>
                                <div class="col-md-3">
                                    <button type="button" class="btn btn-black btn-lg active" name="btn1" value="1" >1</button>
                                </div>

                                <div class="col-md-3">
                                    <button type="button" class="btn btn-black btn-lg active" name="btn2" value="2" >2</button>
                                </div>

                                <div class="col-md-3">
                                    <button type="button" class="btn btn-black btn-lg active" name="btn3" value="3">3</button>
                                </div>
                                <div class="col-md-1"></div>
                            ...
                            <div class="row">
                                <div class="col-md-2"></div>
                                <div class="col-md-3">
                                    <button type="button" class="btn btn-black btn-lg active" name="btn4" value="4">4</button>
                                </div>

                                <div class="col-md-3">
                                    <button type="button" class="btn btn-black btn-lg active" name="5" value="5" >5</button>
                                </div>

                                <div class="col-md-3">
                                    <button type="button" class="btn btn-black btn-lg active"name="btn6" value="6" >6</button>
                                </div>
                                <div class="col-md-1"></div>
                            ...
                            <div class="row">
                                <div class="col-md-2"></div>
                                <div class="col-md-3">
                                    <button type="button" class="btn btn-black btn-lg active"name="btn7" value="7">7</button>
                                </div>

                                <div class="col-md-3">
                                    <button type="button" class="btn btn-black btn-lg active" name="btn8" value="8">8</button>
                                </div>

                                <div class="col-md-3">
                                    <button type="button" class="btn btn-black btn-lg active" name="btn9" value="9">9</button>
                                </div>
                                <div class="col-md-1"></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <button type="button" class="btn btn-black btn-lg active" name="btn0" value="0">0</button>
                                </div>
